/* This file was written by Manuel Quezada de Luna. 
The code was contributed to the deal.II code gallery and this file
is taken from the larger project "two phase flow" available at
...
public:
    ...
    void get_vectors_for_refinement(PETScWrappers::MPI::Vector &locally_relevant_solution_u,
                                    PETScWrappers::MPI::Vector &locally_relevant_solution_unm1,
                                    PETScWrappers::MPI::Vector &locally_relevant_solution_vx,
                                    PETScWrappers::MPI::Vector &locally_relevant_solution_vy,
                                    PETScWrappers::MPI::Vector &old_locally_relevant_solution_vx,
                                    PETScWrappers::MPI::Vector &old_locally_relevant_solution_vy);
    ...
    void get_vectors_for_refinement(PETScWrappers::MPI::Vector &locally_relevant_solution_u,
                                    ...
                                    PETScWrappers::MPI::Vector &old_locally_relevant_solution_vx,
                                    PETScWrappers::MPI::Vector &old_locally_relevant_solution_vy,
                                    PETScWrappers::MPI::Vector &old_locally_relevant_solution_vz);

    void set_vectors_after_refinement(PETScWrappers::MPI::Vector locally_relevant_solution_u,
                                      PETScWrappers::MPI::Vector locally_relevant_solution_unm1,
                                    PETScWrappers::MPI::Vector locally_relevant_solution_vx,
                                    PETScWrappers::MPI::Vector locally_relevant_solution_vy,
                                    PETScWrappers::MPI::Vector old_locally_relevant_solution_vx,
...
//Public functions for refinement done in LayerMovementProblem class
template <int dim>
void LevelSetSolver<dim>::
get_vectors_for_refinement(PETScWrappers::MPI::Vector &locally_relevant_solution_u,
                           PETScWrappers::MPI::Vector &locally_relevant_solution_unm1,
                                PETScWrappers::MPI::Vector &locally_relevant_solution_vx,
                                PETScWrappers::MPI::Vector &locally_relevant_solution_vy,
                                PETScWrappers::MPI::Vector &old_locally_relevant_solution_vx,
                                PETScWrappers::MPI::Vector &old_locally_relevant_solution_vy)
{
  locally_relevant_solution_u=this->un;
  locally_relevant_solution_unm1=this->unm1;
  locally_relevant_solution_vx=this->locally_relevant_solution_vx;
  locally_relevant_solution_vy=this->locally_relevant_solution_vy;
  old_locally_relevant_solution_vx=this->locally_relevant_solution_vx_old;
  old_locally_relevant_solution_vy=this->locally_relevant_solution_vy_old;
...
template <int dim>
void LevelSetSolver<dim>::
set_vectors_after_refinement(PETScWrappers::MPI::Vector locally_relevant_solution_u,
                             PETScWrappers::MPI::Vector locally_relevant_solution_unm1,
                                PETScWrappers::MPI::Vector locally_relevant_solution_vx,
                                PETScWrappers::MPI::Vector locally_relevant_solution_vy,
                                PETScWrappers::MPI::Vector old_locally_relevant_solution_vx,
                                PETScWrappers::MPI::Vector old_locally_relevant_solution_vy)
{
  this->un=locally_relevant_solution_u;
  this->unm1=locally_relevant_solution_unm1;
  this->locally_relevant_solution_vx=locally_relevant_solution_vx;
  this->locally_relevant_solution_vy=locally_relevant_solution_vy;
  this->locally_relevant_solution_vx_old=old_locally_relevant_solution_vx;
  this->locally_relevant_solution_vy_old=old_locally_relevant_solution_vy;
...
///////////////////////////////////
template<int dim>
void LevelSetSolver<dim>::get_unp1(PETScWrappers::MPI::Vector &unp1) {
    unp1=this->unp1;
}
